...
│   ├── js/
│   │   ├── gtm-bootstrap.js
│   │   ├── appsflyer-smart-banner.js
│   │   ├── appsflyer-smart-script.js
│   │   ├── finance-data.js
│   │   ├── finance-home.js
...
- OneLink usage is generated by AppsFlyer Smart Script at runtime
...
- Smart Banner init: `assets/js/appsflyer-smart-banner.js`
  - Loads AppsFlyer Web SDK banner plugin
  - Calls `AF('banners', 'showBanner', { additionalParams })`
  - Adds `deep_link_value` for finance account pages using `data-account-key`
- Smart Script init: `assets/js/appsflyer-smart-script.js`
  - Loads OneLink Smart Script V2 library (if not already loaded)
  - Replaces CTA links (`download_link`, `apple_link`, `banana_link`, `peach_link`)
  - Renders QR codes into page divs (`download_qr_code_div`, `*_qr_code_div`)
